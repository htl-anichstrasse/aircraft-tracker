...
class MySQL {
    ...
    getData(lat1, lon1, lat2, lon2, time) {
        ...
        return new Promise((resolve, reject) => {
            this.con.query('SELECT flightnr, seentime, height, speed, squawk, lat, lon FROM dump1090data WHERE lat BETWEEN ? AND ? AND lon BETWEEN ? AND ? AND seentime BETWEEN ? AND ? GROUP BY flightnr;', 
